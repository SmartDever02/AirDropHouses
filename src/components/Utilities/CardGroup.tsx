...
const CardGroup = () => {
  return (
    <div className='card-group absolute -right-[5vw] md:-right-[3vw] lg:-right-[1vw] xl:-right-[4vw] 2xl:-right-[4vw] -top-[15vw] md:-top-[11vw] lg:-top-[14vw] xl:-top-[15vw] 2xl:-top-[17.7vw] flex gap-[10px] 2xl:gap-[30px] rotate-[-15deg]'>
